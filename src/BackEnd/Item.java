/**
 * Name:Jonathan Maderic Section:1 Program:Final Project Phase 1 Date: 1/26/13
 * Description: This class is the item class that is inherited by the album,audiobook,and
 * film classes
 */
package BackEnd;
...
public abstract class Item {
	 ...
	 *
	 * @param lastUsedId is used to as a constant counter that assigns an id number to
	 * the item
	 ...
	 * @param lastUsedId is used to as a constant counter that assigns an id number to
	 * the item
	 * @param id is used to hold the items id (is zero if the data loader is entering the
	 * value)
	 * @param name is used to hold the name of the item
	 * @param yearOfRelease is used to hold the year the item was released
	 * @param duration is used to hold the the length of the item in seconds
	...
	/**
	 * getCumulativeRating is the accessor method used return the cumulativeRating of the
	 * item
	 *
	...
	/**
	 * getLastUsedId is the accessor method used return the lastUsedId of the item
	 * (global)
	 *
	 * @param lastUsedId is used to hold the lastUsedId of the item
	 *
	...
	/**
	 * getCreator is the accessor method used to return the director, author, or artist
	 * name
	 *
	 ...
	 * @param StopPreveiwPlay is an class the is called when the preveiw should stop
	 * playing
	 *
	 */
	public void playAudioPreview() {
		...
		preveiwTimer.schedule(new StopPreviewPlay(player), PREVEIW_TIME_MILLS);
	}
	...
	/**
	 * This class is the StopPreveiwPlay class that is used to stop the preveiw playback
	 * when the set time is up
	 *
	 * @author Jonathan Maderic
	 * @version 1.0 2/13/13
	 */
	class StopPreviewPlay extends TimerTask {
		//creates an instance of the play back to hold the playback begin stopped

		AudioPlayer player;

		/**
		 * StopPreveiwPlay is the init constructor that atkes int he player curretnyl
		 * playing
		 *
		 * @param player is an instance of the player
		 *
		 */
		public StopPreviewPlay(AudioPlayer player) {
			this.player = player;
		}

		/**
		 * run is the method called whent he timer is done ticking and is public because
		 * it has to be accessed by the system in TimerTask
		 *
		 * @param player is an instance of the player
		 * @param preveiwTimer is an instance of the timer
		 *
