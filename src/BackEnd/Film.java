 ...
 * Date: 1/27/13
 * Description: This class is the Film class that is inherits the Item class
 */

package BackEnd;

/**
 * This class is the Film class that is used to create Film for the store
 * @director Jonathan Maderic
 * @version 1.0 1/27/13
 */
public class Film extends Item
{
  ...
  * @param preview is the string holding the file name of the preview file
  ...
  * @param hidden is the variable that tells is the user can see or buy the item
  ...
  * @param creator is the name of the director for this film
  * @param totalNumberSold is the number of the totalNumberSold for this film
  */
                             ...
                             int totalNumberSold, int lastUsedId) 
  {
    ...
    Film.totalNumberSold = totalNumberSold;
  ...
  * 
  * @param numSold is the number of this film sold
  * @param totalNumberSold is the number of all films sold
  */
  public void buy()
  {
    //PRE:
  ...
  */
  ...
  public String toString()
  {
    ...
    //POST: the film as a string is returned
