/**
 * Name: Jackson Burlew Section: 1 Program: Project 1 Date: 28 January 2013
 * 
*/
package BackEnd;
...
public class User {
	 ...
	 */
	public User(String username, String password, String name, String address, double credit,
	...
	/**
	 * GetInfo() method returns a string containing a lot of information about the
	 * object. Useful for reporting on what the account's status is.
	 */
	...
	/**
	 * purchaseItem will add an item to the list of the user's items and subtract the
	 * amount the transaction cost the user.
	 *
