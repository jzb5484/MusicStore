 ...
 * Date: 2/13/13
 * Description: This class is the AudioPlayer class that playes the audio preveiws in .au format only
 */
...
public class AudioPlayer
{
   ...
   * 
   * @param fileName is the string that holds the file path within the local directory to the file trying to be played
   * @param fileAudio is the string that holds the file path within the local directory to the file trying to be played
   */
  ...
  /**
   * playAudio is the method used to get the audio file and find out if it can be played as well as the format
   * 
   * @param fileName is the string that holds the file path within the local directory to the file trying to be played
   * @param file is the File data type holding the exact file path and is used to get the input stream
   ...
   * @param dataLine holds the info of the audio format which include the file and this is
   * //used to create the output stream
   */
  ...
  /**
   * This class is the PlayThread class that is used to create the output thread for audio playback
   * @author Jonathan Maderic
   * @version 1.0 2/13/13
   */
  class PlayThread extends Thread
  {
    ...
    /**
     * run is the method used to send the audio data fromt eh buffer to the output stream (the speakers)
     * is public becaus ethe system needs to access this to use the speakers as playback
     * 
     * @param output is the output stream running tot he speakers of the computer
     * @param audioInput is the input stream popinting to the file location
     * @param audioFormat holds the format of the current audio file
     * @param buffer is the byte that holds the temporary audio data as it is being sent out to the speakers
     * @param streamSize is the integer that holds the remain number of audio bytes left to be played
     * @param stop is the boolean that tells the thread to stop streaming to the speakers if the user
     * //wants the playback to be stopped
     */
    public void run()
    {
